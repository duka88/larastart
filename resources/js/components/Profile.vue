    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 mt-3">
                ...
                <div class="widget-user-header text-white" style="background-image:url('./img/back.jpeg')">
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane active show" id="settings">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-12">
                                    <textarea class="form-control" id="inputExperience" placeholder="bio" v-model="form.bio"></textarea>
